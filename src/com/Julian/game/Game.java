...
/**
 * A Great and Terrible Beauty 1/20/18
 * 
...
public class Game extends Canvas implements Runnable {
	...
	public static final String NAME = "The Great and Terrible Prison";
	...
	public void render() {
		...
		if (levels.get(currentLevelIndex).getLevelStringPath() == "/Levels/Level_1.0.png") {
			Game.phase = 1;
		} else if (levels.get(currentLevelIndex).getLevelStringPath() == "/Levels/Level_2.0.png") {
			Game.phase = 2;
		} else if (levels.get(currentLevelIndex).getLevelStringPath() == "/Levels/Level_3.0.png") {
			Game.phase = 3;
		} else if (levels.get(currentLevelIndex).getLevelStringPath() == "/Levels/Level_4.0.png") {
			Game.phase = 4;
		}
		
		Font.render("Phase:" + phase, screen, xOffset + (screen.width - 56), yOffset, Colors.get(000, -1, -1, 555), 1);

		if (levels.get(currentLevelIndex).getLevelStringPath() == "/Levels/Level_3.1.png") {
